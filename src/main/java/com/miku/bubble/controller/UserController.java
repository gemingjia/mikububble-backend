...
import com.miku.bubble.model.request.*;
...
public class UserController {
    ...
    public BaseResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        if (deleteRequest == null || deleteRequest.getId() <= 0 || !userService.isAdmin(request)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public BaseResponse<Boolean> updateUserOld(@RequestBody UserUpdateRequest userUpdateRequest, HttpServletRequest request) {
    ...
    public BaseResponse<List<UserVO>> listUser(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        ...
        if (userQueryRequest != null && userService.isAdmin(request)) {
...
//        long userId = currentUser.getId();
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        String redisKey = String.format("mikububble_db:user:recommend:%s", loginUser.getId());
